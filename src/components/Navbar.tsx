        ...
        <div className="menu hidden md:flex gap-5">
          <ul className="flex gap-10 font-semibold items-center text-gray-200 tracking-wide text-base mr-3">
            ...
            <li className="relative group">
              ...
              <ul
                className="absolute left-0 top-full mt-[.5] w-64 bg-[#010101] shadow-lg rounded-md 
            ...
            <li className="relative group">
              ...
              <ul
                className="absolute left-0 top-full mt-[.5] w-60 bg-[#010101] shadow-lg rounded-md 
                           opacity-0 invisible group-hover:visible group-hover:opacity-100 
                           transition-opacity duration-300 delay-300 group-hover:delay-0 z-50"
              >
                <Link href="/rsi/rsi-14">
                  <li className="px-4 py-2 hover:bg-gray-700">
                    Forex Heatmap TV
                  </li>
                </Link>
                ...
                <Link href="/rsi/rsi-7">
                  <li className="px-4 py-2 hover:bg-gray-700">Sentiment</li>
                </Link>
                <Link href="/rsi/rsi-7">
                  <li className="px-4 py-2 hover:bg-gray-700">
                    Daily Highs & Lows
            ...
            <li className="relative group">
              ...
              <ul
                className="absolute left-0 top-full mt-[.5] w-40 bg-[#010101] shadow-lg rounded-md 
                           opacity-0 invisible group-hover:visible group-hover:opacity-100 
                           transition-opacity duration-300 delay-300 group-hover:delay-0 z-50"
              >
                <Link href="/sma/sma-50">
                  <li className="px-4 py-2 hover:bg-gray-700">
                    Financial News
                  </li>
                </Link>
                <Link href="/sma/sma-100">
                  <li className="px-4 py-2 hover:bg-gray-700">Forex News</li>
                </Link>
                <Link href="/sma/sma-200">
                  <li className="px-4 py-2 hover:bg-gray-700">World News</li>
                </Link>
              </ul>
            </li>
            ...
            <li className="relative group inline-block">
              ...
              <ul
                className="absolute left-0 top-full mt-[.5] w-60 bg-[#010101] shadow-lg rounded-md 
                           ...
                           transition-opacity duration-300 delay-300 group-hover:delay-0 z-50"
              >
                <Link href="/atr/atr-basic">
                  <li className="px-4 py-2 hover:bg-gray-700">
                    Impactful News
                  </li>
                </Link>
                <Link href="/atr/atr-advanced">
                  <li className="px-4 py-2 hover:bg-gray-700">
                    Major GeoPolitical News
                  </li>
                </Link>
                <Link href="/atr/atr-settings">
                  <li className="px-4 py-2 hover:bg-gray-700">
                    XAU, USOIL and Major Pair
                  </li>
                </Link>
              </ul>
            </li>
