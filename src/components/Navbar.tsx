...
const Navbar = () => {
  ...
  return (
    <nav className="nav p-6 w-full h-[5rem]  bg-black/30 backdrop-blur-sm shadow-md sticky top-0 z-50">
      <div className="container flex justify-between items-center h-full">
        {/* Logo Section */}
        <Link href={"/"}>
          <div className="logo w-36 flex items-center text-white ">
            <svg
        ...
        <div className="menu flex items-center gap-6">
          <ul className="flex gap-12   text-gray-200 font-semibold tracking-wide text-base ">
            <li>
          ...
          {session ? (
            <Button
              className="w-full md:w-auto text-gray-300 hover:text-white border-gray-500"
              variant="outline"
              onClick={() => signOut()}
            >
              LogOut
