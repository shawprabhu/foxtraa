...
const CommunitySec = () => {
  return (
    <div className="main w-full max-w-[40rem] mt-4 mx-auto">
      <div className="box flex justify-center items-center">
        <div className="hash">
          <span className="font-bold text-3xl sm:text-6xl">
            #JointheFoxTraaCommunity
          </span>
        </div>
      </div>

      <div className="content mt-3 text-center px-4">
        <h3 className="text-base sm:text-xl">
          <span className="">Join the FoxTraa Discord community</span> to
          connect with fellow traders, get real-time market updates, and access
          exclusive trading insights! Let&apos;s take your trading game to the
          next level&#33; together!
        </h3>
      </div>
